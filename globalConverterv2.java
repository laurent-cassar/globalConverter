...
public class globalConverter {
    ...
    public static void performBaseConversion() {
    ...
    public static BaseType getBaseChoice(String prompt) {
        while (true) {
            System.out.println("\n" + prompt + ":");
...
class BaseConverter {
    ...
    public int[] convertToAscii(String input, BaseType sourceBase) {
        switch (sourceBase) {
            case TEXT:
    ...
    public String convertFromAscii(int[] asciiValues, BaseType targetBase) {
        switch (targetBase) {
            case TEXT:
    ...
    public int[] convertTextToAscii(String text) {
    ...
    public String convertAsciiToText(int[] ascii) {
    ...
    public String convertAsciiToBinary(int[] ascii) {
        StringBuilder result = new StringBuilder();
        for (int value : ascii) {
    ...
    public String convertAsciiToOctal(int[] ascii) {
        StringBuilder result = new StringBuilder();
        for (int value : ascii) {
    ...
    public String convertAsciiToDecimal(int[] ascii) {
        StringBuilder result = new StringBuilder();
    ...
    public String convertAsciiToHex(int[] ascii) {
        StringBuilder result = new StringBuilder();
        for (int value : ascii) {
    ...
    public int[] convertOctalToAscii(String octal) {
        // Regrouper par blocs de 3 chiffres octaux
        return parseEncodedString(octal, 8, 3);
    }
    
    public int[] convertDecimalToAscii(String decimal) {
    ...
    public int[] convertHexToAscii(String hex) {
        // Regrouper par blocs de 2 chiffres hexadécimaux
        return parseEncodedString(hex, 16, 2);
    }
    
    public int[] parseEncodedString(String encoded, int base, int blockSize) {
    ...
    public int parseToDecimal(String value, int base) {
        int result = 0;
        int power = 0;
